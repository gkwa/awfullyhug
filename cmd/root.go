...
import (
	...
	"github.com/gkwa/awfullyhug/internal/logger"
)
...
func init() {
	...
	rootCmd.PersistentFlags().StringVar(&cfgFile, "config", "", "config file (default is $HOME/.awfullyhug.yaml)")
...
func initConfig() {
	if cfgFile != "" {
		...
		viper.SetConfigName(".awfullyhug")
	}
